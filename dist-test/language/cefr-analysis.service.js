...
var CefrAnalysisService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.CefrAnalysisService = void 0;
const common_1 = require("@nestjs/common");
const openai_1 = require("openai");
let CefrAnalysisService = CefrAnalysisService_1 = class CefrAnalysisService {
    constructor() {
        this.logger = new common_1.Logger(CefrAnalysisService_1.name);
    ...
    extractCefrLevelFromResponse(responseText) {
        ...
        const patterns = [
            ...
            /creo que tienes un nivel ([ABC][12])/i,
            /tu nivel es ([ABC][12])/i,
        ];
    ...
    async analyzeCefrLevel(language, messages, sessionDurationSeconds) {
    ...
    createAnalysisPrompt(language, conversationText, wordsPerMinute) {
...
Count and analyze filler words like: ${language === 'english' ? 'um, uh, like, you know, actually, basically, literally' : 'eh, este, pues, o sea, bueno, entonces, como que'}`;
    ...
    mapToFeedbackStructure(feedbackData, wordsPerMinute) {
        return {
            pronunciation: {
                score: feedbackData?.pronunciation?.score || 50,
                mispronouncedWords: (feedbackData?.pronunciation?.mispronouncedWords || []).map((word) => ({
                    word: word.word || '',
            ...
            grammar: {
                ...
                errors: (feedbackData?.grammar?.errors || []).map((error) => ({
    ...
    createFallbackFeedback(wordsPerMinute) {
        return {
            pronunciation: {
                score: 50,
                mispronouncedWords: [],
...
exports.CefrAnalysisService = CefrAnalysisService;
exports.CefrAnalysisService = CefrAnalysisService = CefrAnalysisService_1 = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [])
], CefrAnalysisService);
//# sourceMappingURL=cefr-analysis.service.js.map